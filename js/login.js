...
var loginValidar = function(){
	...
	$.ajax({
	    url : rutaWS + "Autenticacion/Login.asmx/LoginChofer",
        type: "POST",
		crossDomain: true,
        dataType : "json",
        ...
        success : function(data, textStatus, jqXHR) {
		  ...
		  if ( resultado.code == 1){			
			...
			$.ajax({
			    url: rutaWS + "Operaciones/Chofer.asmx/ConsultarEmpresas_PorChofer",
				type: "POST",
				crossDomain: true,
				dataType : "json",
				...
				success : function(data, textStatus, jqXHR) {
				  ...
				  //console.log(empresas);
					if ( empresas.length > 0)
					    location.href = "panel.html?idChofer=" + resultado.datos[0].codigo + "&empresa=" + empresas[0].IDCliente;
					else
